...
theme.taglist_fg_focus                          = colors.brightmagenta
...
theme.fg_focus      							= colors.brightmagenta
...
theme.border_focus                              = colors.brightmagenta
theme.border_marked                             = colors.brightmagenta
...
theme.notification_border_color	 				= colors.brightmagenta
...
theme.menu_border_color 						= colors.brightmagenta
...
theme.awesome_icon  							= oip .."logoarch-otis.png"
-- Icons :
